...
public final class SavingsAccountSummary {
    ...
    /**
     * Hold & Release Enhancement: Deducts amount from account balance and adds to total withdrawals. Used by
     * hold-release flow where withdrawal is triggered by release.
     *
     * @param amount
